...
1. Modify your data frame to include the response variable. Name this variable <code>brain_proportion</code>.

2. Remove any observations that have an NA value for either the response or explanatory variable. Hint: use <code>filter</code> and <code>!is.na()</code>.
